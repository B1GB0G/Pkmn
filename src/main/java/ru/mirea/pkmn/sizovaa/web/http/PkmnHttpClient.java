package ru.mirea.pkmn.sizovaa.web.http;
...
public class PkmnHttpClient {
    ...
    public JsonNode getPokemonCard2(String name, String number) throws IOException {
        String requestQuery = "name:\""+name+"\"" + " " + "id:swsh12";
